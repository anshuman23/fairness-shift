...
def test_model(model_, X, y, s1):
    ...
    Pr_y_hat_1_z_0 = float(torch.sum((prediction == 1)[z_0_mask])) / (z_0 + 1e-9)
    Pr_y_hat_1_z_1 = float(torch.sum((prediction == 1)[z_1_mask])) / (z_1 + 1e-9)
    ...
    Pr_y_hat_1_y_0 = float(torch.sum((prediction == 1)[y_0_mask])) / (y_0 + 1e-9)
    Pr_y_hat_1_y_1 = float(torch.sum((prediction == 1)[y_1_mask])) / (y_1 + 1e-9)
    
    Pr_y_hat_1_y_1_z_0 = float(torch.sum((prediction == 1)[y_1_z_0_mask])) / (y_1_z_0 + 1e-9)
    Pr_y_hat_1_y_1_z_1 = float(torch.sum((prediction == 1)[y_1_z_1_mask])) / (y_1_z_1 + 1e-9)
    ...
    Pr_y_hat_1_y_0_z_0 = float(torch.sum((prediction == 1)[y_0_z_0_mask])) / (y_0_z_0 + 1e-9)
    Pr_y_hat_1_y_0_z_1 = float(torch.sum((prediction == 1)[y_0_z_1_mask])) / (y_0_z_1 + 1e-9)
